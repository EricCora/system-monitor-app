...
public struct ProfileSettings: Codable, Sendable, Equatable {
    ...
    public init(
        ...
        self.chartAreaOpacity = chartAreaOpacity.clamped(to: 0.05...0.95)
    ...
    public init(from decoder: Decoder) throws {
        ...
        chartAreaOpacity = (try container.decodeIfPresent(Double.self, forKey: .chartAreaOpacity) ?? 0.72).clamped(to: 0.05...0.95)
